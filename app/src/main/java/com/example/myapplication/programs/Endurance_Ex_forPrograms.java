...
public class Endurance_Ex_forPrograms extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_endurance__ex_for_programs);


        Window w = getWindow();
        w.setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN,WindowManager.LayoutParams.FLAG_FULLSCREEN);

        expandableListView=findViewById(R.id.eListView_5);
       // showList();
    ...
    private void showList() {
        ...
        imagesList.put(chapterList.get(1), image1);
        imagesList.put(chapterList.get(2), image1);
        imagesList.put(chapterList.get(3), image1);
        imagesList.put(chapterList.get(4), image1);
    }
}